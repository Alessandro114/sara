...
const STATIC_FAQ: Record<string, Record<string, string>> = {
    ...
    verticali: {
        it: 'SCALA include 20 verticali specializzati per settore: AdOS (advertising), AgencyOS (agenzie), BeautyOS (beauty), CleanOS (pulizie), DermalyOS (dermatologia), DineOS (ristorazione), FranchiseOS (franchising multi-sede), LandIQ (costruttori e sviluppatori), FacilityOS (facility management), MotorOS (automotive), NetworkOS (network marketing), PraxisOS (studi professionali), ProjectOS (project management), PropertyOS (immobiliare), ReputationOS (reputazione e recensioni), ShopOS (retail), StudioOS (studi creativi), TravelOS (turismo), WellnessOS (fitness e benessere). Ogni verticale ha strumenti AI su misura per il tuo settore! Quale ti interessa?',
        en: 'SCALA includes 20 specialized verticals: AdOS, AgencyOS, BeautyOS, CleanOS, DermalyOS, DineOS, FranchiseOS, LandIQ, FacilityOS, MotorOS, NetworkOS, PraxisOS, ProjectOS, PropertyOS, ReputationOS, ShopOS, StudioOS, TravelOS, WellnessOS. Each has AI tools tailored to your industry! Which one interests you?',
        es: 'SCALA incluye 20 verticales especializados: AdOS, AgencyOS, BeautyOS, CleanOS, DermalyOS, DineOS, FranchiseOS, LandIQ, FacilityOS, MotorOS, NetworkOS, PraxisOS, ProjectOS, PropertyOS, ReputationOS, ShopOS, StudioOS, TravelOS, WellnessOS. ¿Cuál te interesa?',
        pt: 'SCALA inclui 20 verticais especializados: AdOS, AgencyOS, BeautyOS, CleanOS, DermalyOS, DineOS, FranchiseOS, LandIQ, FacilityOS, MotorOS, NetworkOS, PraxisOS, ProjectOS, PropertyOS, ReputationOS, ShopOS, StudioOS, TravelOS, WellnessOS. Qual te interessa?',
    },
    sara_cosa_fai: {
    ...
    demo: {
        it: 'Puoi provare SCALA gratuitamente per 14 giorni su https://app.get-scala.com — nessuna carta richiesta! Inizia con il piano Free (€0) oppure attiva GROWTH con 14 giorni gratuiti.',
        en: 'You can try SCALA free for 14 days at https://app.get-scala.com — no credit card needed! Start with Free (€0) or activate GROWTH with a 14-day free trial.',
        es: 'Puedes probar SCALA gratis 14 dias en https://app.get-scala.com. Empieza con Free (€0) o activa GROWTH con 14 dias gratis.',
        pt: 'Pode experimentar SCALA gratis por 14 dias em https://app.get-scala.com. Comece com Free (€0) ou ative GROWTH com 14 dias gratis.',
    },
    crm: {
        it: 'Il CRM di SCALA e incluso in TUTTI i piani (anche il Free)! Puoi gestire contatti, pipeline vendite, follow-up automatici e integrazioni con WhatsApp e email. Vai su https://app.get-scala.com/crm per iniziare.',
        en: 'SCALA CRM is included in ALL plans (even Free)! Manage contacts, sales pipelines, automatic follow-ups and integrations with WhatsApp and email. Go to https://app.get-scala.com/crm to start.',
        es: 'El CRM de SCALA esta incluido en TODOS los planes (incluso el Free). Gestiona contactos, pipelines, follow-ups automaticos. Ve a https://app.get-scala.com/crm',
        pt: 'O CRM da SCALA esta incluido em TODOS os planos (inclusive o Free). Gerencie contatos, pipelines, follow-ups automaticos. Acesse https://app.get-scala.com/crm',
    },
    enterprise: {
